...
const Headline = () => {
  return (
    <div className="headline">
      ...
      <p>
        We're glad you're here. We've put together a collection of useful tools
        ...
        We're always adding new tools, so be sure to check back often. And if
        you have any suggestions for new tools, please let us know. <br />
